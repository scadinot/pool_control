...
class TestPoolControlStatusSensor:
    ...
    def test_init_with_default_state(self, mock_pool_controller):
    ...
    def test_init_attaches_to_controller(self, mock_pool_controller):
    ...
    def test_init_with_custom_default_state(self, mock_pool_controller):
    ...
    @pytest.mark.asyncio
    async def test_async_added_to_hass(self, mock_pool_controller):
    ...
    def test_state_property(self, mock_pool_controller):
    ...
    def test_set_status_before_ready(self, mock_pool_controller):
    ...
    @pytest.mark.asyncio
    async def test_set_status_after_ready(self, mock_pool_controller):
    ...
    @pytest.mark.asyncio
    async def test_set_status_multiple_times(self, mock_pool_controller):
    ...
    def test_multiple_sensors_different_attributes(self, mock_pool_controller):
...
class TestPoolControlButton:
    ...
    def test_init(self, mock_pool_controller):
    ...
    def test_init_without_callback(self, mock_pool_controller):
    ...
    @pytest.mark.asyncio
    async def test_async_press_calls_callback(self, mock_pool_controller):
    ...
    @pytest.mark.asyncio
    async def test_async_press_without_callback(self, mock_pool_controller):
    ...
    @pytest.mark.asyncio
    async def test_async_press_multiple_times(self, mock_pool_controller):
    ...
    @pytest.mark.asyncio
    async def test_async_press_with_controller_method(self, mock_pool_controller):
    ...
    def test_multiple_buttons_different_callbacks(self, mock_pool_controller):
    ...
    @pytest.mark.asyncio
    async def test_button_name_and_unique_id(self, mock_pool_controller):
...
class TestEntitiesIntegration:
    ...
    @pytest.mark.asyncio
    async def test_sensor_and_button_on_same_controller(self, mock_pool_controller):
    ...
    @pytest.mark.asyncio
    async def test_multiple_sensors_updated_independently(self, mock_pool_controller):
